...
export class ChatService {
    ...
    static async searchFriendsByEmail(email: string) {
        const axiosInstance = createAxiosInstance();
        let result = await axiosInstance.post(`${process.env.NEXT_PUBLIC_BASE_URL}/user`,
            {
                email: email,
            }
        );
    ...
    static async getListRequest() {
        const axiosInstance = createAxiosInstance();
        let result = await axiosInstance.get(`${process.env.NEXT_PUBLIC_BASE_URL}/request-add-friend`);
        return result.data;
    }
    ...
    static async requestAddFriend(receiver: string) {
        const axiosInstance = createAxiosInstance();
        try {
            await axiosInstance.post(`${process.env.NEXT_PUBLIC_BASE_URL}/request-add-friend`,
                {
                    receiver: receiver
                }
            );
    ...
    static async denyFriend(request: string) {
        const axiosInstance = createAxiosInstance();
        try {
            await axiosInstance.post(`${process.env.NEXT_PUBLIC_BASE_URL}/request-add-friend/deny`,
                {
                    request: request
                }
            );
    ...
    static async acceptFriend(request: string) {
        const axiosInstance = createAxiosInstance();
        try {
            await axiosInstance.post(`${process.env.NEXT_PUBLIC_BASE_URL}/request-add-friend/accept`,
                {
                    request: request
                }
            );
